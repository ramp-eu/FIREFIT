...
class Iota:
    ...
    def __build_device(self):
        body = {
            "devices": [
                {
                    "device_id": self.__configuration.classifier_id,
                    "entity_name": self.__configuration.classifier_id,
    ...
    def __send_device_configuration(self, device_json):
        ...
        self.__validate_response(r, self.__configuration.classifier_id)
